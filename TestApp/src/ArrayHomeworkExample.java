 ...
 * на четных позициях во введенном массиве (0 - четное число! )
 */
public class ArrayHomeworkExample {
    public static void main(String[] args) {
        ...
        int sum = 0;
        for (int i = 0; i < n; i = i + 2){//обратите внимание, i увеличиваем на 2, чтобы брать только четные позиции
            sum += arr[i];
        }
